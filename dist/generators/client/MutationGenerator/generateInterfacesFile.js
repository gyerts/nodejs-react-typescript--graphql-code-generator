...
exports.getMutationResponseInterfaceName = function (breadcrumbs) {
    var latestBreadcrumb = breadcrumbs[breadcrumbs.length - 1];
...
exports.generateInterfacesFile = function (allInterfaces, globalInterfaceName) {
    ...
    walker.run();
    fs_1.default.writeFile(settings_1.options.clientOutDir.get() + '/' + "mutation.interfaces.ts", output, function (err) {
        if (err) {
